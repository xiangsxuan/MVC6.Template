 ...
 */
(function(n){n.widget("mvc.mvclookup",{_create:function(){this.element.hasClass("mvc-lookup-input")&&(this._initOptions(),this._initFilters(),this._initAutocomplete(),this._initLookupOpenSpan(),this._loadSelected(),this._cleanUp())},_initOptions:function(){var t=this.element,i=this.options,r;i.hiddenElement=n("#"+t.attr("data-mvc-lookup-for"))[0];i.sortColumn=t.attr("data-mvc-lookup-sort-column");i.sortOrder=t.attr("data-mvc-lookup-sort-order");i.page=parseInt(t.attr("data-mvc-lookup-page"));r=t.attr("data-mvc-lookup-filters");i.filters=r?r.split(","):[];i.search=t.attr("data-mvc-lookup-search");i.title=t.attr("data-mvc-lookup-title");i.rows=t.attr("data-mvc-lookup-rows");i.url=t.attr("data-mvc-lookup-url")},_initFilters:function(){for(var t=0;t<this.options.filters.length;t++)this._initFilter(n("#"+this.options.filters[t]))},_initFilter:function(t){var i=this;i._on(t,{change:function(){var r=n.Event(i._select);i.options.filterChange&&i.options.filterChange(r,i.element[0],i.options.hiddenElement,t[0]);r.isDefaultPrevented()||i._select(null,!1)}})},_initAutocomplete:function(){var t=this;this.element.autocomplete({source:function(i,r){n.ajax({url:t._formAutocompleteUrl(i.term),success:function(t){r(n.map(t.rows,function(n){return{label:n.LookupAcKey,value:n.LookupAcKey,item:n}}))}})},select:function(n,i){t._select(i.item.item,!1);n.preventDefault()},minLength:1,delay:500});this.element.on("keyup.mvclookup",function(i){i.which!=9&&this.value.length==0&&n(t.options.hiddenElement).val()&&t._select(null,!1)});this.element.prevAll(".ui-helper-hidden-accessible").remove()},_initLookupOpenSpan:function(){var r=this.element.nextAll(".mvc-lookup-open-span:first"),i;r.length!=0&&(i=this,this._on(r,{click:function(){var r;t.find(".mvc-lookup-search-input").off("keyup.mvclookup").on("keyup.mvclookup",function(){var n=this;clearTimeout(r);r=setTimeout(function(){i.options.search=n.value;i.options.page=0;i._update(t)},500)}).val(i.options.search);t.find(".mvc-lookup-items-per-page").spinner({change:function(){this.value=i._limitTo(this.value,1,99);i.options.rows=this.value;i.options.page=0;i._update(t)}}).val(i._limitTo(i.options.rows,1,99));t.find(".mvc-lookup-search-input").attr("placeholder",n.fn.mvclookup.lang.search);t.find(".mvc-lookup-error-span").html(n.fn.mvclookup.lang.error);t.dialog("option","title",i.options.title);t.find(".mvc-lookup-table-head").empty();t.find(".mvc-lookup-table-body").empty();i._update(t);setTimeout(function(){var n=t.dialog("open").parent();n.position({my:"center",at:"center",of:window});parseInt(n.css("left"))<0&&n.css("left",0);parseInt(n.css("top"))<0&&n.css("top",0)},100)}}))},_formAutocompleteUrl:function(n){return this.options.url+"?search="+n+"&sortOrder=Asc&rows=20&page=0"+this._formFiltersQuery()},_formLookupUrl:function(n){return this.options.url+"?search="+n+"&sortColumn="+this.options.sortColumn+"&sortOrder="+this.options.sortOrder+"&rows="+this.options.rows+"&page="+this.options.page+this._formFiltersQuery()},_formFiltersQuery:function(){for(var i,r="",t=0;t<this.options.filters.length;t++)i=n("#"+this.options.filters[t]),i.length==1&&(r+="&"+this.options.filters[t]+"="+i.val());return r},_defaultSelect:function(t,i){t?(n(this.options.hiddenElement).val(t.LookupIdKey),n(this.element).val(t.LookupAcKey)):(n(this.options.hiddenElement).val(null),n(this.element).val(null));i||(n(this.options.hiddenElement).change(),n(this.element).change())},_loadSelected:function(){var t=this,i=n(t.options.hiddenElement).val();i&&n.ajax({url:t.options.url+"?id="+i+"&rows=1"+this._formFiltersQuery(),cache:!1,success:function(n){n.rows.length>0&&t._select(n.rows[0],!0)}})},_select:function(t,i){var r=n.Event(this._defaultSelect);this.options.select&&this.options.select(r,this.element[0],this.options.hiddenElement,t,i);r.isDefaultPrevented()||this._defaultSelect(t,i)},_limitTo:function(n,t,i){return(n=parseInt(n),isNaN(n))?20:n<t?t:n>i?i:n},_cleanUp:function(){this.element.removeAttr("data-mvc-lookup-sort-column");this.element.removeAttr("data-mvc-lookup-sort-order");this.element.removeAttr("data-mvc-lookup-filters");this.element.removeAttr("data-mvc-lookup-search");this.element.removeAttr("data-mvc-lookup-title");this.element.removeAttr("data-mvc-lookup-rows");this.element.removeAttr("data-mvc-lookup-page");this.element.removeAttr("data-mvc-lookup-url")},_update:function(t){var i=this,u=t.find(".mvc-lookup-search-input").val(),r;t.find(".mvc-lookup-error-container").fadeOut(300);r=setTimeout(function(){t.find(".mvc-lookup-processing").fadeIn(300);t.find(".mvc-lookup-pager").fadeOut(300);t.find(".mvc-lookup-data").fadeOut(300)},500);n.ajax({url:i._formLookupUrl(u),cache:!1,success:function(n){i._updateHeader(t,n.columns);i._updateData(t,n);i._updateNavbar(t,n.filteredRows);clearTimeout(r);t.find(".mvc-lookup-processing").fadeOut(300);t.find(".mvc-lookup-error-container").hide();t.find(".mvc-lookup-pager").fadeIn(300);t.find(".mvc-lookup-data").fadeIn(300)},error:function(){clearTimeout(r);t.find(".mvc-lookup-error-container").fadeIn(300);t.find(".mvc-lookup-processing").hide();t.find(".mvc-lookup-pager").hide();t.find(".mvc-lookup-data").hide()}})},_updateHeader:function(t,i){for(var u,r=this,f="",e=0;e<i.length;e++)(u=i[e],u.hidden)||(f+='<th class="'+(u.cssClass||"")+'" data-column="'+u.key+'"><span class="mvc-lookup-header-title">'+(u.header||"")+"<\/span>",r.options.sortColumn==u.key||r.options.sortColumn==""&&e==0?(f+='<span class="mvc-lookup-sort-arrow '+(r.options.sortOrder=="Asc"?"asc":"desc")+'"><\/span><\/th>',r.options.sortColumn=u.key):f+='<span class="mvc-lookup-sort-arrow"><\/span><\/th>');t.find(".mvc-lookup-table-head").html("<tr>"+f+'<th class="mvc-lookup-select-header"><\/th><\/tr>');t.find(".mvc-lookup-table-head th").click(function(){var i=n(this);if(!i.attr("data-column"))return!1;r.options.sortOrder=r.options.sortColumn==i.attr("data-column")?r.options.sortOrder=="Asc"?"Desc":"Asc":"Asc";r.options.sortColumn=i.attr("data-column");r._update(t)})},_updateData:function(t,i){var c,s,u,f,l,e,o,h,r;if(i.rows.length==0){c=i.columns?i.columns.length+1:1;t.find(".mvc-lookup-table-body").html('<tr><td colspan="'+c+'" style="text-align: center">'+n.fn.mvclookup.lang.noData+"<\/td><\/tr>");return}for(s="",u=0;u<i.rows.length;u++){for(f="<tr>",l=i.rows[u],e=0;e<i.columns.length;e++)(o=i.columns[e],o.hidden)||(f+='<td class="'+(o.cssClass||"")+'">'+(l[o.key]||"")+"<\/td>");f+='<td class="mvc-lookup-select-cell"><div class="mvc-lookup-select-container"><i><\/i><\/div><\/td><\/tr>';s+=f}for(t.find(".mvc-lookup-table-body").html(s),h=t.find(".mvc-lookup-table-body tr"),r=0;r<h.length;r++)this._bindSelect(t,h[r],i.rows[r])},_updateNavbar:function(n,t){var r=n.find(".mvc-lookup-items-per-page").val(),i=parseInt(t/r)+1;t%r==0&&i--;i==0?n.find(".mvc-lookup-pager > .pagination").empty():this._paginate(i)},_paginate:function(i){var o=Math.floor(this.options.page/5)*5,u=this.options.page,r=o,f="",s=this,e;for(i>5&&u>0&&(f='<li><span data-page="0">&laquo;<\/span><\/li><li><span data-page="'+(u-1)+'">&lsaquo;<\/span><\/li>');r<i&&r<o+5;)e="",r==this.options.page&&(e=' class="active"'),f+="<li"+e+'><span data-page="'+r+'">'+ ++r+"<\/span><\/li>";i>5&&u<i-1&&(f+='<li><span data-page="'+(u+1)+'">&rsaquo;<\/span><\/li><li><span data-page="'+(i-1)+'">&raquo;<\/span><\/li>');t.find(".mvc-lookup-pager > .pagination").html(f).find("li:not(.active) > span").click(function(){s.options.page=parseInt(n(this).data("page"));s._update(t)})},_bindSelect:function(n,t,i){var r=this;r._on(t,{click:function(){n.dialog("close");r._select(i,!1)}})},_destroy:function(){var n=this.element,t=this.options;return n.attr("data-mvc-lookup-filters",t.filters.join()),n.attr("data-mvc-lookup-sort-column",t.sortColumn),n.attr("data-mvc-lookup-sort-order",t.sortOrder),n.attr("data-mvc-lookup-search",t.search),n.attr("data-mvc-lookup-title",t.title),n.attr("data-mvc-lookup-rows",t.rows),n.attr("data-mvc-lookup-page",t.page),n.attr("data-mvc-lookup-url",t.url),n.autocomplete("destroy"),this._super()}});n.fn.mvclookup.lang={error:"Error while retrieving records",noData:"No data found",search:"Search..."};var t=n("#MvcLookup");n(function(){t.find(".mvc-lookup-items-per-page").spinner({min:1,max:99});t.dialog({dialogClass:"mvc-lookup-dialog",autoOpen:!1,minHeight:210,height:"auto",minWidth:455,width:"auto",modal:!0});n(".mvc-lookup-input").mvclookup()})})(jQuery);window.cultures=window.cultures||{};window.cultures.lookup=window.cultures.lookup||{};window.cultures.lookup.en={Error:"Error while retrieving records",NoDataFound:"No data found",Search:"Search..."};window.cultures=window.cultures||{};window.cultures.lookup=window.cultures.lookup||{};window.cultures.lookup.lt={Error:"\u012evyko klaida, susisiekite su administratoriumi",NoDataFound:"Ira\u0161\u0173 nerasta",Search:"Ie\u0161koti..."};
/*!
 * Mvc.Grid 1.1.0
